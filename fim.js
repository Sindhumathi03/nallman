const menuData = {
        ...
        function submitLogin() {
            ...
            // Simple login validation (add your logic for real-world app)
            if (username && password) {
                loggedInUser = username;
                alert('Login successful! Welcome, ' + username);
                cancelLogin(); // Close the login modal
            } else {
        ...
        function checkout() {
            if (!loggedInUser) {
                ...
                showLogin(); // Show the login modal if user is not logged in
                return;
            }

            alert('Checkout complete! Your order has been placed.');
            // Here you can add your checkout logic (e.g., save order to a database, etc.)
        }
