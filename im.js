...
function showLeaveSummary(leaveType, startDate, endDate, reason, message) {
    ...
    const summaryDetails = `
        ...
        <strong>Start Date:</strong> ${startDate}<br><strong>End Date:</strong> ${endDate}<br>
        <strong>Reason:</strong> ${reason}<br><strong>Message:</strong> ${message}<br>
